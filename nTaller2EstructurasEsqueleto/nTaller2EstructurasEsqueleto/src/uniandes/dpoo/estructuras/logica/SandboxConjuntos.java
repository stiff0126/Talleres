...
public class SandboxConjuntos
{
    ...
    {
    	List<String> listaOrdenada = List.copyOf(arbolCadenas);
    ...
    {
    	List<String> listaOrdenada = List.copyOf(arbolCadenas);
    	listaOrdenada.sort((s1, s2) -> s2.compareTo(s1));
        return listaOrdenada;
    }
    ...
    public Collection<String> getSiguientes( String cadena )
    {
    	...
    	for (String elemento : arbolCadenas) {
    		int resultado = cadena.compareTo(elemento);
    		if (resultado<0);
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	for (String string : arbolCadenas) {
			if (cadena.toLowerCase()==string.toLowerCase()) {
				arbolCadenas.remove(string);
			}
    ...
    {
    	NavigableSet<String> arbolCadenas1 = new TreeSet<>();
    	for (Object object : objetos) {
    		arbolCadenas1.add(object.toString());
		}
    	arbolCadenas=arbolCadenas1;
    }
    ...
    public void volverMayusculas( )
    {
    	...
    	for (String cadena : arbolCadenas) {
            arbolCadenas1.add(cadena.toUpperCase());
        }
    	arbolCadenas=arbolCadenas1;
    }
    ...
    {
    	TreeSet<String> arbolCadenasInvertido = new TreeSet<>(String.CASE_INSENSITIVE_ORDER.reversed());

    	for (String string : arbolCadenas) {
			arbolCadenasInvertido.add(string);
		}
