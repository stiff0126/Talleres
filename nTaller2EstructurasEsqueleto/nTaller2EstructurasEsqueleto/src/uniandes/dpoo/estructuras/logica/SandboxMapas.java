...
public class SandboxMapas
{
    ...
    public String getPrimera( )
    {
        ...
        String primeraCadena = set.stream().min(String::compareTo).orElse(null);
    ...
    public String getUltima( )
    {
        ...
        String mayorCadena = set.stream().max(String::compareTo).orElse(null);
    ...
    public Collection<String> getLlaves( )
    {
        ...
        return mapaCadenas.keySet().stream().map(String::toUpperCase).toList();
    }
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	mapaCadenas.put(stringBuilder.reverse().toString(), cadena);
    }
